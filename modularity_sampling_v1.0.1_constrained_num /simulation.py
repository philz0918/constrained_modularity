...
class Simulation:
    ...
    def __init__(self, network, min_val,max_val):
    ...
    def initialize_grouping(self):
        ...
        while cnt == 0 :
            ...
            set_nodes = list(set(nodes))

            if min(nodes.count(i) for i in set_nodes) < self.min or max(nodes.count(i) for i in set_nodes) > self.max :
                cnt = 0
            else :
                cnt = 1
        ...
        if True:
            ...
            if p < self.merge_probability:
                ...
                while cnt == 0 :
                    ...
                    group1 = random.randint(0, c-1)
                    group2 = random.randint(0, c-2)
                ...
                cnt = 0
                while cnt == 0 :
                    old_group = non_empty_groups[random.randint(0, c-1)]
                ...
                while cnt == 0 :
                    ...
                    if len(groups[old_group]) == 1 :
                        ...
                        new_index = random.randint(0,c-2)
                        ...
                        new_index = random.randint(0,c-1)
                    ...
                    #print(groups[old_group])
                    #print(groups[self.point_patch.new_group])

                    if (len(groups[old_group])-1  <self.min) or (len(groups[new_group])+1 > self.max) :
