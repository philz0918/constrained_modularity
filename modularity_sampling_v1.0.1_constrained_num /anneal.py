...
#parser.add_option("-i", "--min-number-of-group", type="int", dest="min_num_of_node", help="Minimum number of nodes in group", default = 1)
#parser.add_option("-a", "--max-number-of-group", type ="int", dest= "max_num_of_node", help = "Maximum number of nodes in group", default =1000)
...
sim = simulation.Simulation(net,1,100)
